...
export const allProjects: ProjectData[] = [
  ...
  },
  {
    ...
    features: [
      "Multimodal AI Perception Agent - Real-time client-side conductor with multi-turn ReAct loop, steering, and context compaction",
      "Visual Canvas Inspection - High-resolution viewport WebP snapshots and geometric scene serialization for spatial AI awareness",
      "Marquee Selection Refinement - Turn rough sketches, handwriting, and wireframes into polished vector diagrams or interactive applets in place",
      "7 Diagram & Applet Engines - Supports Mermaid, Graphviz DOT (WASM), Vega-Lite, SMILES chemistry, BPMN, Cytoscape, LaTeX, and sandboxed HTML5 applets",
      "Infinite 60fps Canvas Architecture - Stacked rendering with offscreen 512px raster tile cache, smooth inertia panning, and pinch-to-zoom (0.03x to 4.0x)",
      "Rich Drawing Toolset - Pressure-sensitive pen, highlighter, precision raycast eraser, vector shapes (rectangle, ellipse, arrow), and inline text",
      "Real-time Collaboration - P2P multiplayer canvas room synchronization and peer cursor tracking powered by WebRTC via PeerJS",
      "Cloud Sync & Offline Support - Automatic cloud persistence to Neon PostgreSQL via Drizzle ORM, with client-side IndexedDB offline fallback",
      "Admin Telemetry Dashboard - Role-based access control (Better Auth RBAC) with canvas playground inspector and full AI token audit logs",
    ],
    technologies: [
      techStack.nextjs,
      techStack.typescript,
